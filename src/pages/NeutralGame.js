    ...
    <div className="gradient-bg font-roboto">
        ...
        <div className='text-white flex flex-col justify-end' style={{backgroundImage: `url(https://via.placeholder.com/1920x1080)`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center',height: '820px'}}>
            <div className='custom-container mb-28'>
                <b className='text-h1'>Neutral Game</b>
                ...
                <div className='flex gap-[16px]'>
                    <div className='bg-white text-black p-2 text-small font-semibold'>Gameplan</div>
                    <div className='bg-white text-black p-2 text-small font-semibold'>Offense</div>
                    <div className='bg-white text-black p-2 text-small font-semibold'>Defense</div>
                </div>
            </div>
        </div>
